...
<head>
    ...
    <title><?php if ($page_title): ?><?php echo $page_title; ?><?php else: ?><?php if ($title): ?><?php echo $title; ?>
        - <?php endif; ?><?php echo $settings['website_title']; ?><?php endif; ?></title>
...
<body
<?php if ($admin): ?> class="admin"<?php endif; ?>>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 logo-wrapper">
                <h1 id="logo">
                    <a href="<?php echo BASE_URL; ?>"><?php echo $settings['website_title']; ?></a>
                    <small><?php echo $settings['website_subtitle']; ?></small>
                </h1>
            </div>
            ...
            <nav id="nav" class="col-md-6">
                ...
                <ul class="nav nav-pills">
                    ...
                    accesskey="<?php echo $item['accesskey']; ?>"<?php endif; ?>><?php echo $item['name']; ?></a>
                    </li><?php endforeach; ?>
                </ul>
                <?php endif; ?>
            </nav>
...
<div class="container">
    ...
    <footer class="row footer">
        <div class="col-lg-12">
            ...
            <?php else: ?>
            <p>
                &copy; <?php echo date("Y"); ?> <?php echo $settings['author']; ?><?php if ($type != 'news' && $type != 'search' && $type != 'notes'): ?>
                <br/><?php echo $lang['page_last_modified']; ?><?php endif; ?><br/>Powered by
                <a href="http://phpsqlitecms.net" rel="nofollow">phpSQLiteCMS</a></p>
            <?php endif; ?>
        </div>
    </footer>
